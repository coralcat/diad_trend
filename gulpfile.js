...
gulp.task("scss", () => {
  ...
  return gulp
    .src(["src/assets/scss/common.scss", "src/assets/scss/style.scss", "src/assets/scss/google.scss", "src/assets/scss/items.scss", "src/assets/scss/modals.scss", "src/assets/scss/responsive.scss"])
